  ...
  return (
    <section className="bg-[#f4f5f9] py-20">
      <div className="max-w-[1440px] mx-auto px-16">
        ...
        <div className="flex items-end justify-between mb-11">
          <div>
            <div className="inline-flex items-center gap-2 bg-[#fff7ed] rounded-full px-3.5 py-1 mb-2.5">
              <span className="text-sm leading-none">🏆</span>
              <span className="text-[11px] font-bold text-brand-gold uppercase tracking-[1.2px]">Top Picks</span>
            </div>
